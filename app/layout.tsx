...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'The missing middleware layer for smart grids. Securely bridge solar, storage, and EV assets to SCADA, VPPs, and DERMS with standardized adapters, CIM models, and AI-powered digital twins. Open source on GitHub.',
  ...
  twitter: {
    ...
    title: 'DERIM | Smart Grid DER Middleware',
    description: 'Connect any DER hardware to any grid system. Adapters • CIM • Digital Twin • FastAPI. Open source.',
  },
};
...
const structuredData = {
  ...
  description:
    'Lightweight open-source integration middleware that enables seamless, standards-aligned connectivity between distributed energy resources (solar PV, BESS, EV chargers) and smart grid applications through pluggable protocol adapters, CIM normalization, and a PyTorch-powered digital twin engine.',
  creator: {
    '@type': 'Person',
              ...
              <div className="footer-content">
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--muted-strong)', lineHeight: '1.6', fontSize: '0.95rem' }}>
                    ...
                    <span style={{ color: '#34d399' }}>Open source • Docker-ready • Production foundation</span>
                  </p>
